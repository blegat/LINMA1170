...
\begin{table}
  ...
  \label{tab:iter}
\end{table}
On constate bien que la méthode de Gauss-Seidel converge plus rapidement que celle de Jacobi. De plus, comme prédit précédemment, la méthode de Jacobi et de Gauss-Seidel divergent pour des valeurs de $a  0.5$
