...
\[
  ...
  \end{pmatrix}.
\]
Appliquons a présent ces méthodes sur un cas concret où la planète mobile a comme caractéristiques initiales : $p_0 = \left(\begin{matrix}
0\\
2
\end{matrix}\right)
$ et $q_0 = \left(\begin{matrix}
0.4\\
0
\end{matrix} \right)
$.\\
