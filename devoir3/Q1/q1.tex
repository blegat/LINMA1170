...
La méthode de Newton définie la fonction d'itération $f$ tel que : $$f:\mathbb{R^n} \Rightarrow \mathbb{R^n} : x \rightarrow F(x)-[DF^(x)]^{-1}F(x). $$
...
Et finalement, attaquons nous au point 5. 
